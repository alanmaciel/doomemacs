...
(after! markdown-mode
  ...
  (custom-set-faces!
    ...
    '(markdown-inline-code-face    :foreground "#5C3D2E" :background "#D5C9BA" :family "Iosevka Nerd Font" :weight light :height 140)
    ;; Code blocks — fondo claramente distinto del fondo de página
    '(markdown-pre-face            :foreground "#5C4A3A" :background "#D8CCBD" :extend t :family "Iosevka Nerd Font" :weight light :height 140)
    '(markdown-code-face           :foreground "#5C4A3A" :background "#D8CCBD" :extend t :family "Iosevka Nerd Font" :weight light :height 140)
