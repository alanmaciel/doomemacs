...
(after! markdown-mode
  ...
  (custom-set-faces!
    ...
    '(markdown-inline-code-face    :foreground "#5C3D2E" :background "#C8B9A6" :family "Iosevka Nerd Font" :weight light :height 140)
    ;; Code blocks — fondo claramente distinto del fondo de página
    '(markdown-pre-face            :foreground "#5C4A3A" :background "#CBBCA9" :extend t :family "Iosevka Nerd Font" :weight light :height 140)
    '(markdown-code-face           :foreground "#5C4A3A" :background "#CBBCA9" :extend t :family "Iosevka Nerd Font" :weight light :height 140)
