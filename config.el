...
(after! markdown-mode
  ...
  (custom-set-faces!
    ...
    ;; Code inline
    '(markdown-inline-code-face    :foreground "#6B4226" :background "#E8E0D4" :family "Iosevka Nerd Font" :weight light :height 140)
    ;; Code blocks
    '(markdown-pre-face            :foreground "#4A3728" :background "#EBE4D8" :extend t :family "Iosevka Nerd Font" :weight light :height 140)
    '(markdown-code-face           :foreground "#4A3728" :background "#EBE4D8" :extend t :family "Iosevka Nerd Font" :weight light :height 140)
    ...
    ;; Blockquotes
    '(markdown-blockquote-face     :foreground "#7A6A5A" :slant italic)
...
Ignora líneas de tabla — valign maneja su display."
  ...
  (defun nb/update-table-overlays ()
    ...
    (let ((bg-alt "#EBE4D8")) ;; tabla: ligeramente más oscuro que el fondo crema
      (save-excursion
        (goto-char (point-min))
