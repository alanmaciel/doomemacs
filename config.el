...
(after! markdown-mode
  ...
  (custom-set-faces!
    ...
    ;; Code inline
    '(markdown-inline-code-face    :foreground "#E8C47C" :background "#2A2017" :family "CaskaydiaMono Nerd Font")
    ;; Code blocks
    '(markdown-pre-face            :foreground "#C8B08A" :background "#1E1810" :extend t :family "CaskaydiaMono Nerd Font")
    '(markdown-code-face           :foreground "#C8B08A" :background "#1E1810" :extend t :family "CaskaydiaMono Nerd Font")
